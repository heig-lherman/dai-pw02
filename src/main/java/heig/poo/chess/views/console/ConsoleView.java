package heig.poo.chess.views.console;

import heig.poo.chess.ChessController;
import heig.poo.chess.PieceType;
import heig.poo.chess.PlayerColor;
import heig.poo.chess.assets.ConsoleAssets;
...
public class ConsoleView extends BaseView<String> {
    ...
    private void askMovement() {
        ...
        while (!ok) {
            ...
            ok = controller.move(charCoordinateToIndex(in.charAt(0)), intCoordinateToIndex(in.charAt(1)), charCoordinateToIndex(in.charAt(2)), intCoordinateToIndex(in.charAt(3)));
